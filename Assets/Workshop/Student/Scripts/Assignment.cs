...
namespace Assignment
{
    public class Assignment : MonoBehaviour
    {
        ...
        public void AS04_AttackEnemy()
        {
            ...
            as04_enemyHP[0] = Mathf.Max(0, as04_enemyHP[0]);
            Debug.Log($"First Enemy hp:{as04_enemyHP[0]}");

            int r = as04_enemyHP.Length - 1;
            as04_enemyHP[r] -= as04_damage;
            as04_enemyHP[r] = Mathf.Max(0, as04_enemyHP[r]);
            Debug.Log($"Last Enemy hp:{as04_enemyHP[r]}");

            as04_enemyHP[as04_target] -= as04_damage;
            as04_enemyHP[as04_target] = Mathf.Max(0, as04_enemyHP[as04_target]);
